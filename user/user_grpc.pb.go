...
type UserDetailsClient interface {
	GetUserByID(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserRequestResponse, error)
	ListUsersByID(ctx context.Context, in *UserListRequest, opts ...grpc.CallOption) (*UserListResponse, error)
}
...
func (c *userDetailsClient) GetUserByID(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserRequestResponse, error) {
...
func (c *userDetailsClient) ListUsersByID(ctx context.Context, in *UserListRequest, opts ...grpc.CallOption) (*UserListResponse, error) {
...
type UserDetailsServer interface {
	GetUserByID(context.Context, *UserRequest) (*UserRequestResponse, error)
	ListUsersByID(context.Context, *UserListRequest) (*UserListResponse, error)
...
func (UnimplementedUserDetailsServer) GetUserByID(context.Context, *UserRequest) (*UserRequestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserByID not implemented")
}
func (UnimplementedUserDetailsServer) ListUsersByID(context.Context, *UserListRequest) (*UserListResponse, error) {
...
func _UserDetails_GetUserByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserDetailsServer).GetUserByID(ctx, req.(*UserRequest))
	}
...
func _UserDetails_ListUsersByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserDetailsServer).ListUsersByID(ctx, req.(*UserListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
